...
Blue Goblin ha encontrado la salida. Se sube a un mecha —o empuña un arma, según
la versión que te cuenten— y con él **sale de la pantalla del móvil**. Ya no es
una imagen sobre la cámara: está en la sala, en tres dimensiones, y lo ves a
través del visor.
...
El paralelo del ejercicio 1 de AR Foundation, ahora en realidad mixta:

> Passthrough + detección de superficies + el mecha de Blue Goblin instanciado
> encima.

Es **deliberadamente corto**. La mitad de la sesión se va en que el ordenador
...
- Al menos una superficie detectada (suelo o mesa).
- El mecha **apoyado** en esa superficie, orientado con ella y a escala real.
